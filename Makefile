...
OBJS = $(LIB_DIR)/FEHLCD.o $(LIB_DIR)/FEHRandom.o $(LIB_DIR)/FEHSD.o $(LIB_DIR)/FEHUtility.o $(LIB_DIR)/tigr.o $(CUS_DIR)/OBJECT.o $(CUS_DIR)/DINO.o $(CUS_DIR)/OBSTACLE.o $(CUS_DIR)/Button.o
